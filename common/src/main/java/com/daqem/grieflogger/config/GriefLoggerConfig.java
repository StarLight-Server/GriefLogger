...
public class GriefLoggerConfig {
    ...
    public enum Language { en_us, nl_nl, zh_tw, zh_cn }
    ...
    static {
        ...
        config.push("server");
        language = config.comment("The language to use for translations (en_us, nl_nl, zh_tw, zh_cn)").onlyOnServer().define("language", Language.zh_cn);
        config.pop();
